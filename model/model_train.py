...
<<<<<<< HEAD
    'Financial Stress', 'Family Expectation', 'Burnout Score', 'Mental Health Index'
]
...
cv_scores = cross_val_score(model_xgb, X_train, y_train, cv=kfold, scoring='accuracy')
=======
